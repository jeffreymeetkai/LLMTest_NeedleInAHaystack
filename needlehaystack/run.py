...
from .providers import Anthropic, ModelProvider, OpenAI, Cohere, Llama
...
class CommandArgs():
    ...
    context_lengths_num_intervals: Optional[int] = 8
    context_lengths: Optional[list[int]] = None
    document_depth_percent_min: Optional[int] = 0
    document_depth_percent_max: Optional[int] = 100
    document_depth_percent_intervals: Optional[int] = 11
...
def get_model_to_test(args: CommandArgs) -> ModelProvider:
    ...
    match args.provider.lower():
        ...
        case "llama":
            return Llama(model_name=args.model_name)
        case _:
