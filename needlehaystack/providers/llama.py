...
class Llama(ModelProvider):
    ...
    def __init__(self,
                 model_name: str = "/workspace/Meta-Llama-3-8B-Instruct",
        ...
        self.model_kwargs["max_new_tokens"] = self.model_kwargs["max_tokens"]
        del self.model_kwargs["max_tokens"]
        if self.model_kwargs["temperature"] == 0:
